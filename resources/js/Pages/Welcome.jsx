...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    return (
        <>
            <Head title="Welcome - Event Management" />
                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        <svg
                                            className="size-6 shrink-0 stroke-blue-600 dark:stroke-blue-400"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth="1.5"
                                ...
                                >
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        <svg
                                            className="size-6 shrink-0 stroke-purple-600 dark:stroke-purple-400"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth="1.5"
                        ...
                        <footer className="py-16 text-center text-sm text-black dark:text-white/70">
                            Event Management System · Laravel v{laravelVersion}{" "}
                            · PHP v{phpVersion}
                        </footer>
                    </div>
                </div>
